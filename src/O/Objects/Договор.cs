...
namespace IIS.O
{
    ...
    [View("ДоговорL", new string[] {
            ...
            "РукОтдЛог.Персонал.ФИО",
            "Контрагент.Организация",
            "Контрагент.ОтветсЛицо",
            "ДатаОконч as \'Дата оконч\'",
            "ДатаНачала as \'Дата начала\'",
            "ОбязанПосред as \'Обязан посред\'"})]
    public class Договор : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.O.Организация fОрганизация;
        
        private IIS.O.Контрагент fКонтрагент;
        
        private IIS.O.РукОтдЛог fРукОтдЛог;
        ...
        [PropertyStorage(new string[] {
                "Контрагент"})]
        [NotNull()]
        public virtual IIS.O.Контрагент Контрагент
        {
            get
            {
                ...
                IIS.O.Контрагент result = this.fКонтрагент;
        ...
        [PropertyStorage(new string[] {
                "Организация"})]
        [NotNull()]
        public virtual IIS.O.Организация Организация
        {
            get
            {
                ...
                IIS.O.Организация result = this.fОрганизация;
        ...
        [PropertyStorage(new string[] {
                "РукОтдЛог"})]
        [NotNull()]
        public virtual IIS.O.РукОтдЛог РукОтдЛог
        {
            get
            {
                ...
                IIS.O.РукОтдЛог result = this.fРукОтдЛог;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View ДоговорE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорE", typeof(IIS.O.Договор));
                }
            }
            ...
            public static ICSSoft.STORMNET.View ДоговорL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("ДоговорL", typeof(IIS.O.Договор));
                }
            }
        }
    }
